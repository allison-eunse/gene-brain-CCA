...
1. **NR3C1** (weight: 0.3786)
2. **CTNND2** (weight: 0.3522)
3. **CSMD1** (weight: 0.3104)
4. **KCNK2** (weight: 0.3026)
5. **GRM7** (weight: 0.1710)

### Negative Weights (Top 5)
1. **ZNF165** (weight: -0.3333)
2. **CAT** (weight: -0.2960)
3. **CHRM2** (weight: -0.2945)
4. **GABRA1** (weight: -0.2072)
5. **OSTM1** (weight: -0.1844)
